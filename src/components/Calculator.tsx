...
const STEPS: StepData[] = [
  ...
  },
  {
    ...
    options: [
      { id: 'brakes_diag', label: 'Проверка на тормозном стенде МАНА', price: 0, oldPrice: 1295 },
      { id: 'brakes_none', label: 'Не нужно', price: 0 }
    ],
    note: 'Бесплатно при выборе базовых работ и покупке запчастей у нас.'
  },
  {
    id: 'chassis',
    ...
    options: [
      { id: 'chassis_diag', label: 'Комплексная диагностика ходовой', price: 0, oldPrice: 1165 },
  ...
  },
  {
    ...
    options: [
      { id: 'engine_diag', label: 'Компьютерная диагностика', price: 0, oldPrice: 1990 },
