...
const CITY_LEGAL_INFO: Record<string, string[]> = {
  ...
  'Псков': [
    'г. Псков, Рижский пр, 82 (ООО «Псков Лада», ОГРН:1196027002214, ИНН 6027196721. Юридический адрес: 180024, г. Псков, Рижский проспект д. 82, пом.3. Почтовый адрес: 180020, г. Псков, ул. Леона Поземского д.112).'
  ],
  'Великий Новгород': [
